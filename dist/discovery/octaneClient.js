...
const getTestRunnerId = (octaneConnection, octaneApi) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while getting test runner id from Octane: " +
            error.message);
        return "";
    }
});
...
const getScmRepo = (octaneConnection, octaneApi) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while getting scm repository from Octane: " +
            error.message);
        return "";
    }
});
...
const getExistingTestsInScmRepo = (octaneConnection, scmRepositoryId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingTests = yield octaneConnection
            .get(alm_octane_js_rest_sdk_1.Octane.entityTypes.tests)
            .fields("id", "executable", "name", "package", "class_name", "description")
            .query(alm_octane_js_rest_sdk_1.Query.field("scm_repository")
            .equal(alm_octane_js_rest_sdk_1.Query.field("id").equal(scmRepositoryId))
            .and(alm_octane_js_rest_sdk_1.Query.field("testing_tool_type").equal(alm_octane_js_rest_sdk_1.Query.field("id").equal("list_node.testing_tool_type.uft")))
            .build())
            .execute();
        ...
        LOGGER.error("Error occurred while getting existing tests in scm repository from Octane: " +
            error.message);
        return [];
    }
});
...
const getExistingUFTTests = (octaneConnection) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingUftTests = yield octaneConnection
            .get(alm_octane_js_rest_sdk_1.Octane.entityTypes.tests)
            .fields("id", "executable", "name", "package", "class_name", "description")
            .query(alm_octane_js_rest_sdk_1.Query.field("testing_tool_type")
            .equal(alm_octane_js_rest_sdk_1.Query.field("id").equal("list_node.testing_tool_type.uft"))
            .build())
            .execute();
        const automatedTests = [];
        ...
        LOGGER.error("Error occurred while getting existing UFT tests from Octane: " +
            error.message);
        return [];
    }
});
...
const sendUpdateTestEventToOctane = (octaneConnection, testId, name, packageName, description, className, isExecutable) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while sending update test event to Octane: " +
            error.message);
    }
});
...
const makeTestNotExecutableInOctane = (octaneConnection, testId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while making test not executable in Octane: " +
            error.message);
    }
});
...
const createScmResourceFile = (octaneConnection, octaneApi, name, relativePath, scmRepoId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while creating scm resource file in Octane: " +
            error.message);
    }
});
...
const updateScmResourceFile = (octaneConnection, octaneApi, scmResourceFileId, name, relativePath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while updating scm resource file in Octane: " +
            error.message);
    }
});
...
const deleteScmResourceFile = (octaneConnection, octaneApi, scmResourceFileId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while deleting scm resource file in Octane: " +
            error.message);
    }
});
...
const getScmResourceFilesFromOctane = (octaneConnection, octaneApi, repoId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        LOGGER.error("Error occurred while getting scm resource files from Octane: " +
            error.message);
        return [];
    }
});
